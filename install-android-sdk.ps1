...
Write-Host ""
Write-Host " Step 4/5: Adding to PATH..." -ForegroundColor Yellow
...
if (-not $userPath.Contains("$SDK_ROOT\cmdline-tools")) {
    ...
    Write-Host " RESTART YOUR TERMINAL for PATH changes to take effect!" -ForegroundColor Red
} else {
    Write-Host " ℹ PATH already configured" -ForegroundColor Cyan
}
...
Write-Host ""
Write-Host "2 Accept licenses:" -ForegroundColor White
Write-Host '   sdkmanager --licenses' -ForegroundColor Gray
Write-Host ""
Write-Host "3 Install components (takes ~10 minutes):" -ForegroundColor White
Write-Host '   sdkmanager "platform-tools" "emulator" "platforms;android-34"' -ForegroundColor Gray
Write-Host ""
Write-Host "4 Install system image (~1.2GB):" -ForegroundColor White
Write-Host '   sdkmanager "system-images;android-34;google_apis;x86_64"' -ForegroundColor Gray
Write-Host ""
Write-Host "5 Create your first AVD:" -ForegroundColor White
