        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'space-between' }}>
                ...
                <button
                    onClick={refresh}
                    disabled={loading}
                    style={{ background: 'transparent', border: '1px solid rgba(255,255,255,0.15)', color: 'var(--vscode-editor-foreground, #fff)', padding: '3px 10px', fontSize: 11, borderRadius: 4, cursor: loading ? 'wait' : 'pointer' }}
            ...
            <input
                ...
                style={{ background: 'rgba(0,0,0,0.25)', border: '1px solid rgba(255,255,255,0.1)', color: 'var(--vscode-editor-foreground, #fff)', padding: '4px 8px', fontSize: 11, borderRadius: 4 }}
            />
