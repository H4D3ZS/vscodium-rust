        ...
        <div style={{ maxWidth: 680 }}>
            ...
            <div className="settings-card">
                ...
                <SettingsRow
                    ...
                    description="Predict the next edit location after accepting a completion (Cursor Prediction style)."
                    control={<Toggle checked={(globalSettings as any).tabPrediction ?? false} onChange={v => setGlobal?.('tabPrediction', v)} />}
                />
            </div>
