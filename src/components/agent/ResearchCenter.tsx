        ...
        <div className="research-center" style={{ flex: 1, padding: '16px', display: 'flex', flexDirection: 'column', gap: '24px', overflowY: 'auto' }}>
            ...
            <div className="glass-panel" style={{ padding: '16px', borderRadius: '14px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', backdropFilter: 'blur(20px)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                    ...
                    <span style={{ fontSize: '11px', fontWeight: 700, color: '#fff', letterSpacing: '0.5px', textTransform: 'uppercase' }}>Symbolic Analysis</span>
                </div>
                <button
                    onClick={onAnalyze}
            ...
            <div className="glass-panel" style={{ padding: '16px', borderRadius: '14px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', backdropFilter: 'blur(20px)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                    ...
                    <span style={{ fontSize: '11px', fontWeight: 700, color: '#fff', letterSpacing: '0.5px', textTransform: 'uppercase' }}>Project Search</span>
                </div>
                <div style={{ display: 'flex', gap: '8px' }}>
                    <input
                        ...
                        style={{
                            ...
                            borderRadius: '6px', padding: '6px 10px', color: '#fff', fontSize: '11px'
                        }}
                    ...
                    <button
                        ...
                        style={{
                            ...
                            border: '1px solid rgba(255,255,255,0.1)', color: '#fff', fontSize: '11px', cursor: 'pointer'
                        }}>
            ...
            <div className="glass-panel" style={{ padding: '16px', borderRadius: '14px', background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', backdropFilter: 'blur(20px)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
                    ...
                    <span style={{ fontSize: '11px', fontWeight: 700, color: '#fff', letterSpacing: '0.5px', textTransform: 'uppercase' }}>Advanced Research</span>
                </div>
                <textarea
                    value={researchQuery}
                    ...
                    style={{
                        ...
                        borderRadius: '8px', padding: '10px', color: '#fff', fontSize: '11px', marginBottom: '12px', resize: 'none',
                        fontFamily: 'inherit'
                    }}
                />
                <button
