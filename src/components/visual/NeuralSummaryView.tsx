...
const NeuralSummaryView: React.FC = () => {
    const { brainTelemetry: data, refreshBrainTelemetry } = useStore(useShallow(s => ({
        brainTelemetry: s.brainTelemetry,
        refreshBrainTelemetry: s.refreshBrainTelemetry,
    })));
    ...
    return (
        <div style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '24px', overflowY: 'auto', height: '100%', color: 'var(--vscode-editor-foreground, #fff)' }}>
