...
export class AIRICybersecurityEngine {
    ...
    private static readonly MAX_THREAT_HISTORY = 500;
    ...
    reportThreat(threat: NetworkThreat): void {
        ...
        if (this.threatHistory.length > AIRICybersecurityEngine.MAX_THREAT_HISTORY) {
            this.threatHistory = this.threatHistory.slice(-AIRICybersecurityEngine.MAX_THREAT_HISTORY);
        }
