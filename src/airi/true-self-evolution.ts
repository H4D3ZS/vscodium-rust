...
export class AIRISelfEvolution {
    ...
    private static readonly MAX_EVOLUTION_HISTORY = 100;
    ...
    async evolve(): Promise<void> {
        ...
        try {
            ...
            // Cap evolution history
            if (this.evolutionHistory.length > AIRISelfEvolution.MAX_EVOLUTION_HISTORY) {
                this.evolutionHistory = this.evolutionHistory.slice(-AIRISelfEvolution.MAX_EVOLUTION_HISTORY);
            }
