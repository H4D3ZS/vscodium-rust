...
#[tauri::command]
pub async fn account_get(state: State<'_, std::sync::Arc<crate::EditorState>>) -> Result<serde_json::Value, String> {
...
#[tauri::command]
pub async fn account_tos_status(state: State<'_, std::sync::Arc<crate::EditorState>>, doc_id: String) -> Result<bool, String> {
...
#[tauri::command]
pub async fn account_has_feature(state: State<'_, std::sync::Arc<crate::EditorState>>, feature: String) -> Result<bool, String> {
...
#[tauri::command]
pub async fn account_has_feature_offline(state: State<'_, std::sync::Arc<crate::EditorState>>, feature: String) -> Result<bool, String> {
    let acc = AccountManager::load(&state.config_dir);
...
#[tauri::command]
pub async fn account_set_tier(state: State<'_, std::sync::Arc<crate::EditorState>>, tier: String) -> Result<(), String> {
    let mut acc = AccountManager::load(&state.config_dir);
...
#[tauri::command]
pub async fn account_start_trial(state: State<'_, std::sync::Arc<crate::EditorState>>) -> Result<serde_json::Value, String> {
    let mut acc = AccountManager::load(&state.config_dir);
    if acc.trial_used {
...
#[tauri::command]
pub async fn account_sync(state: State<'_, std::sync::Arc<crate::EditorState>>) -> Result<serde_json::Value, String> {
    Ok(build_view(&state.config_dir).await)
}
...
#[tauri::command]
pub async fn account_add_tokens(state: State<'_, std::sync::Arc<crate::EditorState>>, tokens: u64) -> Result<(), String> {
...
#[tauri::command]
pub async fn account_check_and_count(state: State<'_, std::sync::Arc<crate::EditorState>>) -> Result<serde_json::Value, String> {
    let acc = AccountManager::load(&state.config_dir);
...
#[tauri::command]
pub async fn account_open_billing(state: State<'_, std::sync::Arc<crate::EditorState>>) -> Result<(), String> {
...
#[tauri::command]
pub async fn account_usage(state: State<'_, std::sync::Arc<crate::EditorState>>) -> Result<serde_json::Value, String> {
    let acc = AccountManager::load(&state.config_dir);
    let ent = entitlements_for(&acc);
    let month = chrono::Local::now().format("%Y-%m").to_string();
    let day = chrono::Local::now().format("%Y-%m-%d").to_string();
