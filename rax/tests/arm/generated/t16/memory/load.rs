...
/// Provenance: aarch32_POP_T1_A
/// ASL: `field P 24 +: 1`
/// Requirement: FieldBoundary { field: "P", value: 0, boundary: Min }
/// minimum value
#[test]
fn test_aarch32_pop_t1_a_field_p_0_min_0_bc000000() {
    // Thumb encoding (32): 0xBC000000
    // Test aarch32_POP_T1_A field P = 0 (Min)
    // ISET: T32
    // Fields: P=0, register_list=0
...
/// maximum value (1)
#[test]
fn test_aarch32_pop_t1_a_field_p_1_max_0_bd000000() {
    // Thumb encoding (32): 0xBD000000
    // Test aarch32_POP_T1_A field P = 1 (Max)
    // ISET: T32
    // Fields: P=1, register_list=0
    let mut cpu = create_thumb_cpu();
...
/// minimum value
#[test]
fn test_aarch32_pop_t1_a_field_register_list_0_min_0_bc000000() {
    // Thumb encoding (32): 0xBC000000
    // Test aarch32_POP_T1_A field register_list = 0 (Min)
    // ISET: T32
    // Fields: register_list=0, P=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBC000000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
...
/// value 1
#[test]
fn test_aarch32_pop_t1_a_field_register_list_1_poweroftwo_0_bc010000() {
    // Thumb encoding (32): 0xBC010000
    // Test aarch32_POP_T1_A field register_list = 1 (PowerOfTwo)
    // ISET: T32
    // Fields: P=0, register_list=1
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBC010000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
    assert_eq!(
        exit,
...
/// midpoint (127)
#[test]
fn test_aarch32_pop_t1_a_field_register_list_127_poweroftwominusone_0_bc7f0000() {
    // Thumb encoding (32): 0xBC7F0000
    // Test aarch32_POP_T1_A field register_list = 127 (PowerOfTwoMinusOne)
    // ISET: T32
    // Fields: register_list=127, P=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBC7F0000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
    assert_eq!(
        exit,
...
/// maximum value (255)
#[test]
fn test_aarch32_pop_t1_a_field_register_list_255_max_0_bcff0000() {
    // Thumb encoding (32): 0xBCFF0000
    // Test aarch32_POP_T1_A field register_list = 255 (Max)
    // ISET: T32
    // Fields: P=0, register_list=255
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBCFF0000;
    write_insn(&mut cpu, 0, encoding);
    let exit = cpu.step().unwrap();
    assert_eq!(
        exit,
...
/// P=0 (minimum value)
#[test]
fn test_aarch32_pop_t1_a_combo_0_0_bc000000() {
    // Thumb encoding (32): 0xBC000000
    // Test aarch32_POP_T1_A field combination: P=0, register_list=0
    // ISET: T32
    // Fields: register_list=0, P=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBC000000;
...
#[test]
fn test_aarch32_pop_t1_a_invalid_0_0_bc000000() {
    // Thumb encoding (32): 0xBC000000
    // Test aarch32_POP_T1_A invalid encoding: Binary { op: Lt, lhs: Call { name: QualifiedIdentifier { qualifier: Any, name: "BitCount" }, args: [Var(QualifiedIdentifier { qualifier: Any, name: "registers" })] }, rhs: LitInt(1) }
    // ISET: T32
    // Fields: register_list=0, P=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBC000000;
...
/// triggers Unpredictable
#[test]
fn test_aarch32_pop_t1_a_invalid_1_0_bc000000() {
    // Thumb encoding (32): 0xBC000000
    // Test aarch32_POP_T1_A invalid encoding: Unconditional UNPREDICTABLE
    // ISET: T32
    // Fields: P=0, register_list=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBC000000;
...
/// triggers Unpredictable
#[test]
fn test_aarch32_pop_t1_a_invalid_2_0_bc000000() {
    // Thumb encoding (32): 0xBC000000
    // Test aarch32_POP_T1_A invalid encoding: Binary { op: Eq, lhs: Index { base: Var(QualifiedIdentifier { qualifier: Any, name: "registers" }), indices: [Single(LitInt(15))] }, rhs: Binary { op: And, lhs: Binary { op: And, lhs: LitBits([true]), rhs: Call { name: QualifiedIdentifier { qualifier: Any, name: "InITBlock" }, args: [] } }, rhs: Unary { op: Not, operand: Call { name: QualifiedIdentifier { qualifier: Any, name: "LastInITBlock" }, args: [] } } } }
    // ISET: T32
    // Fields: P=0, register_list=0
    let mut cpu = create_thumb_cpu();
    let encoding: u32 = 0xBC000000;
...
/// triggers Unpredictable
#[test]
fn test_aarch32_pop_t1_a_invalid_3_0_bc000000() {
    // Thumb encoding (32): 0xBC000000
    // Test aarch32_POP_T1_A invalid encoding: Unconditional UNPREDICTABLE
    // ISET: T32
    // Fields: register_list=0, P=0
...
/// shift by 0 (32)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_32_0_bc020020() {
...
/// shift by 0 (64)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_64_0_bc020020() {
...
/// shift by 4 (32)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_32_1_bc020020() {
...
/// shift by 4 (64)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_64_1_bc020020() {
...
/// shift by 8 (32)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_32_2_bc020020() {
...
/// shift by 8 (64)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_64_2_bc020020() {
...
/// MSB set, shift 1 (32)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_32_3_bc020020() {
...
/// MSB set, shift 1 (64)
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_64_3_bc020020() {
...
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_32_4_bc020020() {
...
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_64_4_bc020020() {
...
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_32_5_bc020020() {
...
#[test]
fn test_aarch32_pop_t1_a_lslv_oracle_64_5_bc020020() {
...
/// no shift
#[test]
fn test_aarch32_pop_t1_a_t16_oracle_0_bc000000() {
...
/// shift by 4
#[test]
fn test_aarch32_pop_t1_a_t16_oracle_1_bc000000() {
...
/// MSB set, shift 1
#[test]
fn test_aarch32_pop_t1_a_t16_oracle_2_bc000000() {
...
/// shift to MSB
#[test]
fn test_aarch32_pop_t1_a_t16_oracle_3_bc000000() {
...
/// triggers Unpredictable
#[test]
fn test_aarch32_pop_t1_a_exception_0_bc000000() {
    // Test aarch32_POP_T1_A exception: Unpredictable
    // ISET: T16
    let mut cpu = create_test_cpu();
    let encoding: u16 = 0x0000;
    // T16: Write 16-bit instruction
