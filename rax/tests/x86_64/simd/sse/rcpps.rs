...
fn test_rcpps_small_values() {
    // Test reciprocal of small values (large results)
    let code = [
        0x0f, 0x53, 0xf7, // RCPPS XMM6, XMM7
        0xf4, // HLT
    ];
...
fn test_rcpps_large_values() {
    // Test reciprocal of large values (small results)
    let code = [
        0x45, 0x0f, 0x53, 0xc1, // RCPPS XMM8, XMM9
        0xf4, // HLT
    ];
...
fn test_rcpps_negative_values() {
    // Test reciprocal of negative values
    let code = [
        0x45, 0x0f, 0x53, 0xf7, // RCPPS XMM14, XMM15
        0xf4, // HLT
    ];
...
fn test_rcpps_precision_test() {
    // Test precision of approximation (various divisors)
    let code = [
        0x0f, 0x53, 0xf7, // RCPPS XMM6, XMM7
        0xf4, // HLT
    ];
