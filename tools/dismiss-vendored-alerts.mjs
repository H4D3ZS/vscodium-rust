 ...
 *   node tools/dismiss-vendored-alerts.mjs                 # dry-run
 *   node tools/dismiss-vendored-alerts.mjs --apply         # actually dismiss
 *
...
async function dismissAlert(number, reason, comment) {
